...
const OSWAP_OracleChainlinkFiatBinance_json_1 = __importDefault(require("./OSWAP_OracleChainlinkFiatBinance.json"));
class OSWAP_OracleChainlinkFiatBinance extends eth_contract_1.Contract {
