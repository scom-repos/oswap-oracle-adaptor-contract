...
const OSWAP_OracleChainlinkPriceGuardFiatGeneric_json_1 = __importDefault(require("./OSWAP_OracleChainlinkPriceGuardFiatGeneric.json"));
class OSWAP_OracleChainlinkPriceGuardFiatGeneric extends eth_contract_1.Contract {
