...
const OSWAP_OracleChainlinkPriceGuardFiatBinance_json_1 = __importDefault(require("./OSWAP_OracleChainlinkPriceGuardFiatBinance.json"));
class OSWAP_OracleChainlinkPriceGuardFiatBinance extends eth_contract_1.Contract {
