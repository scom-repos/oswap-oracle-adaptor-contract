...
const OSWAP_OracleChainlinkFiatAvalanche_json_1 = __importDefault(require("./OSWAP_OracleChainlinkFiatAvalanche.json"));
class OSWAP_OracleChainlinkFiatAvalanche extends eth_contract_1.Contract {
