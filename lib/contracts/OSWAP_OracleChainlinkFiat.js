...
const OSWAP_OracleChainlinkFiat_json_1 = __importDefault(require("./OSWAP_OracleChainlinkFiat.json"));
class OSWAP_OracleChainlinkFiat extends eth_contract_1.Contract {
