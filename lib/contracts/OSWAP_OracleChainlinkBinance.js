...
const OSWAP_OracleChainlinkBinance_json_1 = __importDefault(require("./OSWAP_OracleChainlinkBinance.json"));
class OSWAP_OracleChainlinkBinance extends eth_contract_1.Contract {
