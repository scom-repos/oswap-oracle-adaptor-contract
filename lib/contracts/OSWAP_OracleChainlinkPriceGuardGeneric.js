...
const OSWAP_OracleChainlinkPriceGuardGeneric_json_1 = __importDefault(require("./OSWAP_OracleChainlinkPriceGuardGeneric.json"));
class OSWAP_OracleChainlinkPriceGuardGeneric extends eth_contract_1.Contract {
