...
import Bin from "./OSWAP_OracleChainlinkLimitedRinkeby.json";

export class OSWAP_OracleChainlinkLimitedRinkeby extends Contract{
    constructor(wallet: IWallet, address?: string){
        super(wallet, address, Bin.abi, Bin.bytecode);
        this.assign()
    }
    deploy(params:{factory:string,dai:string,usdc:string}): Promise<string>{
        return this._deploy(params.factory,params.dai,params.usdc);
    }
