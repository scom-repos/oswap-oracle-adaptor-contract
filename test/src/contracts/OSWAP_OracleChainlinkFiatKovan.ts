...
import Bin from "./OSWAP_OracleChainlinkFiatKovan.json";

export class OSWAP_OracleChainlinkFiatKovan extends Contract{
    constructor(wallet: IWallet, address?: string){
        super(wallet, address, Bin.abi, Bin.bytecode);
        this.assign()
    }
    deploy(params:{eth:string,dai:string,usdc:string,usdt:string}): Promise<string>{
        return this._deploy(params.eth,params.dai,params.usdc,params.usdt);
    }
