...
import Bin from "./OSWAP_OracleChainlinkLimitedRinkebyTestnet.json";

export class OSWAP_OracleChainlinkLimitedRinkebyTestnet extends Contract{
    constructor(wallet: IWallet, address?: string){
        super(wallet, address, Bin.abi, Bin.bytecode);
        this.assign()
    }
    deploy(params:{factory:string,weth:string,dai:string}): Promise<string>{
        return this._deploy(params.factory,params.weth,params.dai);
    }
