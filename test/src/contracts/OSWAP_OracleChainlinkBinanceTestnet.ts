...
import Bin from "./OSWAP_OracleChainlinkBinanceTestnet.json";

export class OSWAP_OracleChainlinkBinanceTestnet extends Contract{
    constructor(wallet: IWallet, address?: string){
        super(wallet, address, Bin.abi, Bin.bytecode);
        this.assign()
    }
    deploy(params:{wbnb:string,dai:string}): Promise<string>{
        return this._deploy(params.wbnb,params.dai);
    }
