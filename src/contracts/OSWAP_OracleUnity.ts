...
export class OSWAP_OracleUnity extends _Contract{
    ...
    private assign(){
        ...
        let getLatestPriceParams = (params: IGetLatestPriceParams) => [params.param1,params.param2,this.wallet.utils.stringToBytes(params.param3)];
        ...
        let getRatioParams = (params: IGetRatioParams) => [params.param1,params.param2,this.wallet.utils.toString(params.param3),this.wallet.utils.toString(params.param4),this.wallet.utils.stringToBytes(params.param5)];
